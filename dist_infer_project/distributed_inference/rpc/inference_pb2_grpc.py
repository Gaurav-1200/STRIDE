...
class PartitionWorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Forward = channel.unary_unary(
                '/distributed_inference.PartitionWorker/Forward',
        ...
        self.Health = channel.unary_unary(
                '/distributed_inference.PartitionWorker/Health',
...
class PartitionWorkerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_PartitionWorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'distributed_inference.PartitionWorker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('distributed_inference.PartitionWorker', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class PartitionWorker(object):
    """Missing associated documentation comment in .proto file."""
